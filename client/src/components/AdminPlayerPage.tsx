...
export const AdminPlayerPage: React.FC<AdminPlayerPageProps> = ({ embedded = false }) => {
  const content = (
    <div className="card border-0 shadow-sm rounded-4">
      <div className="card-body p-4">
        <div className="admin-player-frame">
          <iframe title="Quran Broadcast Player" src="/?mode=player" />
        </div>
      </div>
    </div>
  );
    ...
    <div className="admin-dashboard" dir="rtl">
      <aside className="admin-sidebar">
        ...
        <nav className="admin-nav">
          <a className="admin-nav-link active" href="/admin/?section=player"><span>▶️</span><span>المشغل</span></a>
      ...
      <main className="admin-main">
        <header className="admin-topbar">
          ...
          <div className="d-flex gap-2 flex-wrap">
            <a className="btn btn-primary rounded-pill px-4" href="/?mode=player" target="_blank" rel="noreferrer">فتح Player مستقل</a>
